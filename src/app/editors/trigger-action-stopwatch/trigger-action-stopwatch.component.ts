...
@Component( {
    selector: 'app-trigger-action-stopwatch',
    templateUrl: 'trigger-action-stopwatch.component.html',
    styleUrls: [ 'trigger-action-stopwatch.component.scss' ],
} )
export class TriggerActionStopwatchComponent implements OnInit {
